...
function Login() {
  ...
  const validate = () => {
    if (!companyName.trim()) return "Company Name is required"; // 🟢 NEW VALIDATION
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      // 🟢 Added companyName to the request body
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: pageBg }}>
      <form onSubmit={handleSubmit} style={{ width: "350px", padding: "30px", background: cardBg, borderRadius: "10px", boxShadow: "0 10px 25px rgba(0,0,0,0.15)" }}>
        ...
        {/* 🟢 COMPANY NAME INPUT */}
        <label style={{ display: "block", fontSize: "13px", fontWeight: "600", color: labelClr, marginBottom: "5px" }}>Company Name</label>
        <input
          type="text"
