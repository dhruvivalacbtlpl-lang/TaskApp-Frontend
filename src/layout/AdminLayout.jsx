...
function AdminLayout() {
  ...
  return (
    <Flex minH="100vh" overflow="hidden">
      {/* ── SIDEBAR ── */}
      <Box w={sidebarOpen ? EXPANDED_W : COLLAPSED_W} bg={sidebarBg} color="white"
        ...
        <Flex justify={sidebarOpen ? "space-between" : "center"} align="center" mb="8" px="2">
          ...
          <IconButton size="sm" variant="ghost" color="whiteAlpha.700"
        ...
        <VStack align="stretch" spacing="2">
          ...
          {/* Project Hub */}
          <Box>
            <Flex align="center" p="12px" cursor="pointer" borderRadius="lg"
      ...
      <Flex flex="1" direction="column" minW={0}>
        {/* TOPBAR */}
        <Flex h="70px" bg={topbarBg} borderBottom="1px solid" borderColor={topbarBorder}
          px="6" align="center" justify="space-between" boxShadow="sm">
          <HStack spacing={4}>
            {projects?.length > 0 ? (
              <Select size="sm" w="250px" variant="filled" borderRadius="md"
            ...
            <Menu>
              ...
              <MenuList border="none" boxShadow="xl">
                <MenuItem icon={<MdPerson size={18}/>}
                  onClick={() => navigate("/admin/profile")}>My Profile</MenuItem>
                <MenuItem icon={<MdBusiness size={18}/>}
                  onClick={() => navigate("/admin/company-profile")}>Company Profile</MenuItem>
                {(isAdmin || isOwner) && (
                  <MenuItem icon={<MdSettings size={18}/>}
                    onClick={() => navigate("/admin/company-settings")}>Company Settings</MenuItem>
                )}
                <Divider />
                <MenuItem icon={<MdLogout size={18}/>} color="red.500"
